...
function print_otvety($family1, $name1)
{
    $question = array(
        ...
        "Какой ответ ставится, если продавец (на кассе) спросил про бонусную карту после того, как назвал сумму покупки?",
    ...
    $answers = array(
        ...
        "8 баллов",
        "Оценка проставляется в зависимости от количества и точности выполненных фраз",
        "Нет",
        ...
        "Наличие только максимальных оценок и наибольшее количество оценок по сравнению с другими",
