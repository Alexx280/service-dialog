...
<div id='centr-q'>
    <div id="quest">
        ...
        <form method="post" action="<?php echo "0" . (substr(__FILE__, 38, 2) + 1) ?>.php">
            Какова цель проверок Тайными покупателями?<br><br>
            <p class="mini">
                <input id="em1" class="checkbox" type="checkbox" name="text1" value="Осуществление контроля соблюдения стандартов обслуживания. <br>" />
                <label for="em1" title="ответов может быть несколько" >Осуществление контроля соблюдения стандартов обслуживания </label> <br>
                <input id="em2" class="checkbox" type="checkbox" name="text2" value="Повышение лояльности персонала к покупателям. <br>" />
                <label for="em2" title="ответов может быть несколько">Повышение лояльности персонала к покупателям </label> <br>
                ...
                <label for="em3" title="ответов может быть несколько">Обратная связь покупателей о качестве обслуживания в магазине </label> <br>
                <input id="em4" class="checkbox" type="checkbox" name="text4" value="Развитие профессионального уровня сотрудников магазина. <br>" />
                <label for="em4" title="ответов может быть несколько">Развитие профессионального уровня сотрудников магазина </label> <br>
