...
$pass = 0;
if ($chisla > 0 && $simvoly > 0 && $kiril > 0 && count($password) > 7) {
    $pass = 1;
} else {
};
echo "Pass=" . $pass . "вот";
...
if ($row['quest_01'] == 0 || $row['quest_02'] == 0 || $pass == 0) {
    $ssd1 = 'Требования к паролю, ';
} else {
};
if ($row['quest_03'] == 0) {
    $ssd3 = 'Использование электронной почты, ';
} else {
};
if ($row['quest_04'] == 0) {
    $ssd4 = 'Использование компьютера на рабочем месте, ';
} else {
};
if ($row['quest_05'] == 0) {
    $ssd5 = 'Использование корпоративной сети и Интернет, ';
} else {
};
if ($row['quest_06'] == 0) {
    $ssd6 = 'Доступ и ответственность, ';
} else {
};
if ($row['quest_07'] == 0) {
    $ssd7 = 'Коммерческая тайна, ';
} else {
};
if ($row['quest_08'] == 0) {
    $ssd8 = 'Передача файлов, ';
} else {
};
if ($row['quest_09'] == 0) {
    $ssd9 = 'Срочная работа, ';
...
if ($row['quest_10'] == 0) {
    $ssd11 = 'Регламентирующие документы. ';
} else {
};
