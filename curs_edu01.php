...
<div id="edu">
    ...
    <p class="animated bounceInUp delay1">
        <i> Информационная безопасность </i> – это защищенность информации и поддерживающей инфраструктуры от случайных
        или преднамеренных
        воздействий естественного или искусственного характера, чреватых нанесением ущерба владельцам или пользователям
        информации
        и поддерживающей инфраструктуры. Компания может пострадать (понести убытки) не только от несанкционированного
        доступа,
        ...
        <i>Коммерческая тайна</i> - это конфиденциальность информации, позволяющая ее обладателю при существующих или
        возможных
        ...
        снижение эффективности работы других отделов (бухгалтерии, отдела кадров, коммерческого департамента,
        операционного департамента).<br>
    ...
    <div class="butt2">
        <a href="curs_edu02.php">
            <button type="button" id="win" class="btn btn-success btn-lg btn3d"><span
                    class="glyphicon glyphicon-ok"></span> Вперёд
            </button>
        </a>
    </div>
    <div class="butt3" id="win1">
        <a href="#">
            <button type="button" id="win" class="btn btn-danger btn-lg btn3d" title="Перейти на начальную страницу"
                    onclick='messageShow()'><span class="glyphicon glyphicon-remove"></span></button>
        </a>
    </div>
