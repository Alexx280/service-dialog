...
<div id='centr-q'>
    <div id="quest">
        ...
        <form method="post" action="<?php echo "0" . (substr(__FILE__, 38, 2) + 1) ?>.php">
            ...
            <p class="mini">
                <input id="em1" class="checkbox" type="checkbox" name="email1" value="5 баллов" />
                <label for="em1">1.	Посмотрите на покупателя и улыбнитесь</label> <br>
                <input id="em2" class="checkbox" type="checkbox" name="email1" value="5 баллов" />
                <label for="em2">2.	Поздоровайтесь: «Здравствуйте!»</label> <br>
                <input id="em3" class="checkbox" type="checkbox" name="email1" value="5 баллов" />
                <label for="em3">3.	Спросите у покупателя: «Вам пакет большой или маленький?»</label> <br>
                <input id="em4" class="checkbox" type="checkbox" name="email1" value="5 баллов" />
                <label for="em4">4.	Спросите у покупателя: «У вас есть бонусная карта?» </label> <br>
                <input id="em5" class="checkbox" type="checkbox" name="email1" value="5 баллов" />
                ...
                <input id="em6" class="checkbox" type="checkbox" name="email1" value="5 баллов" />
                <label for="em6">6.	Назовите стоимость покупки </label> <br>
                <input id="em7" class="checkbox" type="checkbox" name="email1" value="5 баллов" />
                <label for="em7">7.	Назовите сумму денег, полученную от Покупателя: «Ваши ….» , и положите их на виду у  Покупателя </label> <br>
                <input id="em8" class="checkbox" type="checkbox" name="email1" value="5 баллов" />
                <label for="em8">8.	Отбейте чек </label> <br>
                <input id="em9" class="checkbox" type="checkbox" name="email1" value="5 баллов" />
                ...
                <input id="em0" class="checkbox" type="checkbox" name="email1" value="5 баллов" />
                ...
                <input id="em" class="checkbox" type="checkbox" name="email1" value="5 баллов" />
