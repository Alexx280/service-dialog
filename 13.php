...
<div id='centr-q'>
    <div id="quest">
        ...
        <form method="post" action="<?php echo(substr(__FILE__, 38, 2) + 1) ?>.php" style="">
            ...
            <label for="kt2">Наибольшее количество оценок по сравнению с другими  </label><br>
            ...
            <label for="kt3">Наличие только максимальных оценок и наибольшее количество оценок по сравнению с другими</label><br>
