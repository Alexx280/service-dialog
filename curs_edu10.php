...
<div id="edu">
    ...
    <p class="animated bounceInUp delay1">
        Для всех сотрудников в компании применяется дисциплинарная ответственность за не соблюдение требований
        информационной безопасности(замечание, выговор, увольнение)
        ...
        Подробные виды нарушений и количество баллов перечислены в <a href="education/06.dot"
                                                                      style="color: lightskyblue"> "Положении об
            ответственности
            сотрудников Группы компаний «Лама» по инцидентам нарушения информационной безопасности"</a>, также документ
        можно найти в папке:
        \Info\Документы ИБ
        <br><br>
        ...
        - Нарушение установленного законом порядка сбора, хранения, использования или распространения информации о
        гражданах (персональных данных)(Статья 13.11 КоАП);<br>
