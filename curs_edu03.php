...
<div id="edu">
    ...
    <p class="animated bounceInUp delay1">Пользователи, уходя со своего рабочего места, должны блокировать доступ к
        своему рабочему компьютеру
        (сочетание клавиш «CTRL+ALT+DEL» и выбрать «Заблокировать компьютер», либо достаточно нажать клавиши “Windows” +
        L).</p>

    <img src="pic/connect.jpg" class="animated fadeInRightBig rightimg" id="pic11">

    <p class="animated bounceInUp delay1">
        При печати документов на сетевой общий принтер, распечатанные листы следует забирать незамедлительно, сразу
        после отправки на печать.
        Запрещается:<br>
