...
<div id='centr-q'>
    <div id="quest">
        ...
        <form method="post" action="<?php echo(substr(__FILE__, 38, 2) + 1) ?>.php" style="">
            ...
            <input id="kt1" class="checkbox" type="checkbox" name="text1" value="Подробную анкету. <br>" />
            <label for="kt1">Подробную анкету</label><br>
            <input id="kt2" class="checkbox" type="checkbox" name="text2" value="Отчет по анкетам. <br>" />
            <label for="kt2">Отчет по анкетам   </label><br>
            <input id="kt3" class="checkbox" type="checkbox" name="text3" value="Отчет по кассирам. <br>" />
