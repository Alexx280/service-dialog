...
<html>
<div id="edu">
    <p class="animated bounceInUp">Запрещается: </p><img src="pic/rem_comp3.jpg"
                                                         class="animated fadeInRightBig rightimg">
    ...
    <p class="animated bounceInUp">
        ...
        программные и технические средства (в т.ч. телефоны и флэш карты);</p>  <img src="pic/usb2.jpg"
                                                                                     class="animated fadeInRightBig rightimg">

    <p class="animated bounceInUp">
        - оставлять свою включенную рабочую станцию без контроля и допускать к ней посторонних лиц.<br>
        - использовать массовую рассылку в программе обмена мнгновенными сообщениями ("Lynk" / "Skype для бизнеса") для
    ...
    <div class="progress top-bar">
        <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="1" aria-valuemin="0"
             aria-valuemax="10" style="width:40%">
            40%
        </div>
    </div>
</div>
